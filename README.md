...
一套专业的脑暴、需求分析、产品设计、编码规划与实施命令工具，基于 Markdown 文件的持久化记忆系统，帮助高效完成软件开发全流程。

## ✨ 核心特性

- 📝 **渐进式工作流程**：脑暴 → 需求分析 → PRD / 设计方案 → 编码计划 → 代码实施
...
- `.ai-configs/brainstorm/` - 脑暴记录
- `.ai-configs/analysis/` - 需求分析报告
- `.ai-configs/design/` - 设计方案
...
### 1. `/brainstorm` - 脑暴与方向探索

**用途**：在需求尚未收敛时快速发散思路、比较方案、明确未知项
...
- 包含：问题定义、核心场景、方案选项、风险与未知项、推荐方向

**示例**：
```bash
/brainstorm 告警中心改版方向
/brainstorm 报表导出能力怎么做更合理
```

---

### 2. `/req-analyze` - 需求分析（推荐第一步）
...
**用途**：基于需求分析和 PRD 输出可实施的产品/交互/界面设计方案

**适用场景**：
- ✅ 需求已经较清晰，但界面和交互规则尚未定义
- ✅ 需要补齐页面结构、组件规则、状态设计
- ✅ 复杂列表、弹窗、表单、工作台页面需要统一设计

**输出**：
- `.ai-configs/design/YYYY/MM/[功能名称]-设计方案.md`
- 包含：设计目标、信息架构、关键交互、组件规则、状态设计、交付清单

**示例**：
```bash
/design 告警历史导出 Excel 功能
```

---

### 5. `/create-plan` - 生成编码计划
...
```bash
1️⃣ /brainstorm [主题]
   ↓ 10-20 分钟：发散方向、比较方案、识别未知项
   ✅ 输出：脑暴记录

2️⃣ /req-analyze [需求描述]
...
4️⃣ /design [功能描述]
   ↓ 15-30 分钟：定义信息架构、交互规则、状态设计
   ✅ 输出：设计方案

5️⃣ /create-plan [功能描述]
   ↓ 30-40 分钟：引用分析报告+PRD+设计方案，生成实施计划
   ✅ 输出：编码计划（Phase 复选框格式）
