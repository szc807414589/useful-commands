...
### 轻量模式
- 适用于复现路径明确、根因局部且修复面很小的 bug
- 可以缩短方案比较和文档描述，但不能跳过验证
...
**阶段 2：影响分析**
1. 搜索 replaceQuery 的所有使用（`rg "replaceQuery"`）
2. 发现多处使用，影响范围中等
